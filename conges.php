                ...
                <div class="col-12">
                  <div class="card recent-sales overflow-auto">
                    ...
                    <div class="modal fade" id="addcongesemploye" tabindex="-1" data-bs-backdrop="false">
                      ...
                      <div class="modal fade" id="deleteconges" tabindex="-1">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Supprimer demande de congès</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              Êtes-vous sûr de supprimer cette demande de congès?
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                              <button id="btn_delete_conges" type="button" class="btn btn-danger">Supprimer</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="modal fade" id="approveconges" tabindex="-1">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Approuver demande de congès <span id="ap_idconges"></h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              Êtes-vous sûr d'approuver cette demande de congès?
                              <canvas id="congesapproveemploye" style="max-height: 400px;"></canvas>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                              <button id="btn_approve_conges" type="button" class="btn btn-success">Approuver</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="modal fade" id="refuseconges" tabindex="-1">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Refuser demande de congès <span id="re_idconges"></h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              Êtes-vous sûr de refuser cette demande de congès?
                              <canvas id="congesrefuseemploye" style="max-height: 400px;"></canvas>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                              <button id="btn_refuse_conges" type="button" class="btn btn-danger">Refuser</button>
                            </div>
                          </div>
                        </div>
                      </div>
                    <div class="card-body">
                      ...
                      <div class="table-responsive-xxl" id="table-conges-list"></div>
