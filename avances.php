                ...
                <div class="col-12">
                  <div class="card recent-sales overflow-auto">
                    ...
                    <div class="modal fade" id="addcongesemploye" tabindex="-1" data-bs-backdrop="false">
                      ...
                      <div class="modal fade" id="deleteavance" tabindex="-1">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Supprimer demande d'avance</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              Êtes-vous sûr de supprimer cette demande d'avance?
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                              <button id="btn_delete_avance" type="button" class="btn btn-danger">Supprimer</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="modal fade" id="approveavance" tabindex="-1">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Approuver demande d'avance <span id="ap_idavance"></h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              Êtes-vous sûr d'approuver cette demande d'avance?
                              <canvas id="avanceapproveemploye" style="max-height: 400px;"></canvas>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                              <button id="btn_approve_avance" type="button" class="btn btn-success">Approuver</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="modal fade" id="refuseavance" tabindex="-1">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Refuser demande d'avance <span id="re_idavance"></h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              Êtes-vous sûr de refuser cette demande d'avance?
                              <canvas id="avancerefuseemploye" style="max-height: 400px;"></canvas>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
                              <button id="btn_refuse_avance" type="button" class="btn btn-danger">Refuser</button>
                            </div>
                          </div>
                        </div>
                      </div>
                    <div class="card-body">
                      ...
                      <div class="table-responsive-xxl" id="table-avance-list"></div>
